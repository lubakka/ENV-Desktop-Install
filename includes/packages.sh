...
git git-core graphviz  
libtool 
mariadb-server memcached mercurial meld 
ntp ntpdate nodejs 
openssl openssh-server 
php56w 
php56w-devel php56w-dba 
php56w-cli php56w-common 
php56w-gd 
php56w-imap php56w-interbase php56w-intl 
php56w-mbstring php56w-mcrypt php56w-mssql php56w-mysql  
php-pear 
php56w-snmp php56w-soap 
php56w-ldap 
php56w-fpm 
php56w-xml php56w-xmlrpc 
php56w-opcache php56w-odbc
phpmyadmin python-yaml php56w-pdo 
sudo 
tree  
unzip 
zip 
